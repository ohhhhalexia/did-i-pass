...
import { getAStudent, getAllStudents } from './controllers/StudentController';
...
app.post('/api/students', notImplemented); // create a new student
app.get('/api/students/:studentName', getAStudent); // Get a student's data
